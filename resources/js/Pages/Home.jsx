            ...
            {user ? (
              <>
               <Button
                  variant="ghost"
                  size="sm"
                  className="rounded-full border-b-2 border-yellow-300"
                  asChild
                >
      ...
      <main className="bg-[#f9f9f9] px-2 md:px-6">
        ...
        <section className="relative w-full h-[600px] rounded-3xl overflow-hidden mx-auto mt-12">
          ...
          <div className="absolute bottom-0 left-0 w-full p-10 flex flex-col md:flex-row md:items-end md:justify-between z-10">
            ...
            <Button className="mt-8 md:mt-0 bg-yellow-300 hover:bg-yellow-400 text-gray-900 font-semibold px-10 py-4 rounded-full text-lg shadow-lg transition" asChild>
